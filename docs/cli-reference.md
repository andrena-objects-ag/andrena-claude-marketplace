...
| `claude -r "<session>" "query"` | Resume session by ID                                   | `claude -r "abc123" "Finish this PR"`             |
| `claude update`                 | Update to latest version                               | `claude update`                                   |
| `claude mcp`                    | Configure Model Context Protocol (MCP) servers         | See the [MCP documentation](./mcp.md).            |
...
| `-p` / `--print`                 | Print response without interactive mode (non-interactive / SDK mode)                                           | `claude -p "query"`                                                   |
...
| `--model`                        | Sets the model for the current session with an alias (`sonnet` or `opus`) or a model's full name               | `claude --model claude-sonnet-4-20250514`                             |
