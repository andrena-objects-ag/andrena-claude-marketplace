 ...
 * lands in user entries is filtered: session handoffs, skill base-directory
 * injections, harness <task-notification>/<bash-stdout> echoes, and bare UI
 * slash commands (/clear, /model). Pass --all to include them (tagged with
 * their kind).
 */
